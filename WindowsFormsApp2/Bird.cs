...
namespace WindowsFormsApp2
{
    public class Bird
    {
        ...
        public string hatch_date { get; set; }
        ...
        public Bird()
        {
            ...
            species = "NONE";
            subspecies = "NONE";
            hatch_date = DateTime.Now.ToString();
            gender = "NONE";
            cage_number = "0";
        }
        public Bird(ulong serial, string species, string subspecies, string hatch_date, string gender, string cage_number, string mother_serial, string father_serial)
        {
            Serial = serial;
